...
public class ParticlesSystem {
    // klasa emitujaca czasteczki, tworzy nowe

    // generuje losowe wartosci ich kierunku
    // pozwala na modyfikowanie ich ilosci na sekunde (pps)
    // predkosci poruszania sie (speed), oddzialywania grawitacji (gravityComplient)
    // dlosc zycia (lifeLenght) i skali (scale)
